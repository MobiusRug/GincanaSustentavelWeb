...
public class ProdutoController {
	...
	public String salva(@Valid @ModelAttribute Produto produto, BindingResult result, RedirectAttributes attr, ModelMap model) {
		...
		if (produto.getId() == null) {
			...
			attr.addFlashAttribute("feedback", "O item foi cadastrado com sucesso");
		}
		else { 
			produtoBO.atualiza(produto);
			attr.addFlashAttribute("feedback", "O item foi atualizado com sucesso");
		}
	...
	public String ativa(@PathVariable("id") Long id, RedirectAttributes attr) {
		try {
			...
			attr.addFlashAttribute("feedback", "O item foi ativado com sucesso");
		} catch (Exception e) {
			e.printStackTrace();
		}
		return "redirect:/reciclaveis";
	...
	public String remove(@PathVariable("id") Long id, RedirectAttributes attr) {
		Produto pe = produtoBO.pesquisaPeloId(id);
		produtoBO.remove(pe);
		attr.addFlashAttribute("feedback", "Item removido com sucesso");
		return "redirect:/reciclaveis";
	}
